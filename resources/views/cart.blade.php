						...
						<table class="cart-table">
							...
							<tbody>
								<tr class="table-body-row">
									...
									<td class="product-image"><img src="{{ asset('car_parking/assets/img/products/product-img-1.jpg') }}" alt=""></td>
								...
								<tr class="table-body-row">
									<td class="product-remove"><a href="#"><i class="far fa-window-close"></i></a></td>
									<td class="product-image"><img src="{{ asset('car_parking/assets/img/products/product-img-2.jpg') }}" alt=""></td>
								...
								<tr class="table-body-row">
									<td class="product-remove"><a href="#"><i class="far fa-window-close"></i></a></td>
									<td class="product-image"><img src="{{ asset('car_parking/assets/img/products/product-img-3.jpg') }}" alt=""></td>
