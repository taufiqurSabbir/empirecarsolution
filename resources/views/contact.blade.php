...
<body>
			...
			<div class="row">
				<div class="col-lg-12 col-sm-12 text-center">
					<div class="main-menu-wrap">
						...
						<nav class="main-menu">
							<ul>
								<li class="current-list-item"><a href="{{ route('about') }}">Home</a>
			...
			<div class="row">
				<div class="col-lg-8 mb-5 mb-lg-0">
					...
					<div class="contact-form">
						<form method="POST" action="{{ route('contact_info') }}">
							@csrf
					...
					@if (session('info_insert_status'))
                                <br>
                                <br>
                                <div class="alert alert-info" role="alert">
                                    <span class="text-danger">{{ session('info_insert_status') }}</span>
				...
				<div class="col-lg-4">
					<div class="contact-form-wrap">
						<div class="contact-form-box">
							...
							<p>United City <br> Madani Ave. <br> Dhaka 1212</p>
						</div>
						<div class="contact-form-box">
						...
						<div class="contact-form-box">
							...
							<p>Phone: +00 111 222 3333 <br> Email: mroy193154@bscse.uiu.ac.bd</p>
						</div>
					</div>
				</div>
			</div>
	...
	<!-- form validation js -->
	<script src="{{ asset('car_parking/assets/js/form-validate.js') }}"></script>
	<!-- main js -->
